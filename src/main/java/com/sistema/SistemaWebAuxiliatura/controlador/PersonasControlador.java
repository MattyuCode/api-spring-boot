...
//LOGRADO
    ...
    public ResponseEntity<?> ConsultarPersonas() {
        List<Listadogeneralpersona> listarPersona = this.servicioIMPL.listarTodasLasPersonas();
    ...
    public ResponseEntity<?> CrearPersonas(@RequestBody Listadogeneralpersona listadogeneralpersona) {
        Listadogeneralpersona PersonaCreada = this.servicioIMPL.CrearPersona(listadogeneralpersona);
    ...
    public ResponseEntity<?> ModificarPersona(@RequestBody Listadogeneralpersona listadogeneralpersona) {
        ...
        Listadogeneralpersona personaExiste = this.servicioIMPL.BuscarPersona(listadogeneralpersona.getIdPersona());
        ...
        Listadogeneralpersona EditarPersona = this.servicioIMPL.ModificarPersona(personaExiste);
    ...
    public ResponseEntity<?> BuscarPersona(@PathVariable long idPersona) {
        Listadogeneralpersona BuscarPersonaById = this.servicioIMPL.BuscarPersona(idPersona);
    ...
    public ResponseEntity<?> EliminarPersona(@PathVariable long idPersona) {
        this.servicioIMPL.EliminarPersona(idPersona);
